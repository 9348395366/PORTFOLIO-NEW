...
import { Github, Linkedin, Mail, Phone, MessageCircle, ArrowUpCircle } from "lucide-react";
...
const SocialCard = ({ icon: Icon, title, handle, link, delay, strokeWidth = 1.5, openInNewTab = true }) => {
  return (
    <motion.a
      href={link}
      ...
      <div className="content-overlay">
        ...
        <div className="cards-grid">  
          <SocialCard
            ...
            link="https://www.linkedin.com/in/chandan9348395366/"
            delay={0.2}
            strokeWidth={1.5}
          />
          <SocialCard
            ...
            link="https://github.com/9348395366"
            delay={0.4}
            strokeWidth={1.7} 
          />
          <SocialCard
            ...
            link="mailto:chandannanda345@gmail.com"
            delay={0.6}
            strokeWidth={1.2} 
            openInNewTab={false}
          />
          <SocialCard
            icon={Phone}
            title="Call"
            handle="+91 9348395366"
            link="tel:+919348395366"
            delay={0.8}
            strokeWidth={1.7}
            openInNewTab={false}
          />
